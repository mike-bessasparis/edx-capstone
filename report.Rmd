...
# recommended top 5 items for user user
#recommended.items.u8 <- predict(Rec.model, affinity.matrix["8",], n=5)
# to display them
#as(recommended.items.u8, "list")


# Predict list of product which can be recommended to given users	 	
#to predict affinity to all non-rated items 
predicted.affinity.u <- predict(Rec.model, affinity.matrix["30",], type="ratings")
as(predicted.affinity.u, "list")
# .. and the real affinity for the items obtained from the affinity.matrix
as(affinity.matrix["30",], "list")
