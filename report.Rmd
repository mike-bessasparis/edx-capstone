...
# set up x-fold cross validation procedure
train_control <- trainControl(method = "cv", 
                              number = 5)

fit <- train(rating ~ userId + movieId, method = "nb", data = train_set, trControl = train_control)

naive_bayes_predictions <- predict(fit, test_set, type="raw")

confusionMatrix(naive_bayes_predictions, test_set$rating)
...
pred_matrix <- readRDS(file = "./rda/top1000_IBCF_pred_matrix.rds")
