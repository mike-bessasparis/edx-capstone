...
First we build the datasets.  I used the provided script which downloads the raw
data and takes care of correctly building the edx and validation datasets.  I
saved these as .rds objects.  I then take the edx dataset and split it into a
...
and add the preditcion to the ensemble. Finally, I evaluate the ensemble by
...
saveRDS(RMSE_ensemble, "./rda/final-rmse.rds")

rm(movie_time_bias, user_bias, mu, train_set, eval_set, edx, validation, RMSE, cl)
